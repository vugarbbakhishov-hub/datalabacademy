...
$dlBlogRecent = array_slice($dlBlogPosts, 0, 3);
?>
<!DOCTYPE html>
<html lang="az">
...
<head>
    ...
    <title>DatalabAcademy Bloq — Data, SQL, Excel və AI məqalələri</title>
    <meta name="robots" content="index, follow">
    <meta name="description" content="DatalabAcademy bloqu: Data Analitika, SQL, Excel və AI üzrə praktiki məqalələr, trend izahları və karyera məsləhətləri.">
    <meta name="keywords" content="DatalabAcademy blog, data analitika, SQL, Excel, AI, süni intellekt, analitika məqalələri">
    ...
    <meta property="og:title" content="DatalabAcademy Bloq — Data, SQL, Excel və AI">
    <meta property="og:description" content="Data, SQL, Excel və AI üzrə praktik məqalələr və karyera yönümlü materiallar.">
    <meta property="og:image" content="https://datalabacademy.az/assets/images/course/datalab-data-analitika.svg">
    <meta property="og:url" content="https://datalabacademy.az/blog-with-sidebar">
    ...
    <meta name="twitter:title" content="DatalabAcademy Bloq">
    <meta name="twitter:description" content="Data, SQL, Excel və AI üzrə praktik məqalələr.">
    <meta name="twitter:image" content="https://datalabacademy.az/assets/images/course/datalab-data-analitika.svg">
    <link rel="canonical" href="https://datalabacademy.az/blog-with-sidebar">
    <link rel="alternate" hreflang="az-AZ" href="https://datalabacademy.az/blog-with-sidebar">
...
<div data-datalab-header></div>
    ...
    <main class="datalab-blog-area">
        <div class="rbt-page-banner-wrapper datalab-blog-banner">
            <div class="rbt-banner-image"></div>
            <div class="rbt-banner-content">
                <div class="rbt-banner-content-top">
                    <div class="container">
                        <div class="row"><div class="col-lg-12">
                            <ul class="page-list"><li class="rbt-breadcrumb-item"><a href="index.php" data-i18n="nav_home">Ana səhifə</a></li><li><div class="icon-right"><i class="feather-chevron-right"></i></div></li><li class="rbt-breadcrumb-item active" data-blog-i18n="blog_bc">Bloq</li></ul>
                            <div class="title-wrapper"><h1 class="title mb--0" data-blog-i18n="blog_title">DatalabAcademy bloqu</h1><a href="#blog-list" class="rbt-badge-2"><div class="image">✦</div> <span data-blog-i18n="blog_badge">Praktiki məqalələr</span></a></div>
                            <p class="description" data-blog-i18n="blog_desc">Data Analitika, SQL, Excel və AI üzrə işdə tətbiq edə biləcəyiniz qısa və praktik yazılar.</p>
                        </div></div>
                    </div>
                </div>
            </div>
        </div>
        <div id="blog-list" class="rbt-section-overlayping-top rbt-section-gapBottom">
            <div class="container"><div class="row row--30 gy-5"><div class="col-lg-8"><div class="row g-5">
                <?php foreach ($dlBlogPosts as $post):
                    $detailHref = 'blog-details?slug=' . rawurlencode((string) ($post['slug'] ?? $post['id'] ?? ''));
                    $titleAz = (string) ($post['titleAz'] ?? '');
                    $titleEn = (string) (($post['titleEn'] ?? '') ?: $titleAz);
                    $excerptAz = (string) ($post['excerptAz'] ?? '');
                    $excerptEn = (string) (($post['excerptEn'] ?? '') ?: $excerptAz);
                    $readAz = (string) ($post['readTimeAz'] ?? '');
                    $readEn = (string) (($post['readTimeEn'] ?? '') ?: $readAz);
                    $image = dl_blog_image($post);
                ?>
                <div class="col-lg-6 col-md-6 col-12">
                    <article class="rbt-blog-grid rbt-card variation-02 rbt-hover datalab-blog-card">
                        <div class="rbt-card-img"><a href="<?php echo dl_blog_e($detailHref); ?>"><img src="<?php echo dl_blog_e($image); ?>" alt="<?php echo dl_blog_e($titleAz ?: $titleEn); ?>" loading="lazy" onerror="this.onerror=null;this.src='assets/images/blog/blog-grid-01.jpg';"></a></div>
                        <div class="rbt-card-body">
                            <span class="datalab-blog-chip"><?php echo dl_blog_e((string) ($post['category'] ?? 'Bloq')); ?></span>
                            <h5 class="rbt-card-title"><a href="<?php echo dl_blog_e($detailHref); ?>" data-dl-blog-lang data-az="<?php echo dl_blog_e($titleAz); ?>" data-en="<?php echo dl_blog_e($titleEn); ?>"><?php echo dl_blog_e($titleAz ?: $titleEn); ?></a></h5>
                            <ul class="blog-meta"><li><i class="feather-user"></i> <?php echo dl_blog_e((string) ($post['author'] ?? 'DatalabAcademy')); ?></li><li><i class="feather-clock"></i> <?php echo dl_blog_e(dl_blog_date((string) ($post['publishedDate'] ?? ''))); ?></li><li><i class="feather-watch"></i> <span data-dl-blog-lang data-az="<?php echo dl_blog_e($readAz); ?>" data-en="<?php echo dl_blog_e($readEn); ?>"><?php echo dl_blog_e($readAz ?: $readEn); ?></span></li></ul>
                            <p class="rbt-card-text" data-dl-blog-lang data-az="<?php echo dl_blog_e($excerptAz); ?>" data-en="<?php echo dl_blog_e($excerptEn); ?>"><?php echo dl_blog_e($excerptAz ?: $excerptEn); ?></p>
                            <div class="rbt-card-bottom"><a class="transparent-button" href="<?php echo dl_blog_e($detailHref); ?>"><span data-blog-i18n="blog_read_more">Daha ətraflı</span><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a></div>
                        </div>
                    </article>
                </div>
                <?php endforeach; ?>            </div></div>
            <div class="col-lg-4">
                <aside class="rbt-sidebar-widget-wrapper rbt-gradient-border datalab-blog-sidebar">
                    <div class="rbt-single-widget rbt-widget-search"><div class="inner"><form action="#" class="rbt-search-style-1"><input type="text" placeholder="Bloqda axtarın" data-blog-i18n-placeholder="blog_search"><button class="search-btn" aria-label="Search"><i class="feather-search"></i></button></form></div></div>
                    <div class="rbt-single-widget rbt-widget-recent">
                        <div class="inner">
                            <h4 class="rbt-widget-title" data-blog-i18n="blog_recent">Son yazılar</h4>
                            <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                <?php foreach ($dlBlogRecent as $recent):
                                    $recentHref = 'blog-details?slug=' . rawurlencode((string) ($recent['slug'] ?? $recent['id'] ?? ''));
                                    $recentTitleAz = (string) ($recent['titleAz'] ?? '');
                                    $recentTitleEn = (string) (($recent['titleEn'] ?? '') ?: $recentTitleAz);
                                    $recentImage = dl_blog_image($recent);
                                ?>
                                <li><div class="thumbnail"><a href="<?php echo dl_blog_e($recentHref); ?>"><img src="<?php echo dl_blog_e($recentImage); ?>" alt="<?php echo dl_blog_e($recentTitleAz ?: $recentTitleEn); ?>" onerror="this.onerror=null;this.src='assets/images/blog/blog-grid-01.jpg';"></a></div><div class="content"><h6 class="title"><a href="<?php echo dl_blog_e($recentHref); ?>" data-dl-blog-lang data-az="<?php echo dl_blog_e($recentTitleAz); ?>" data-en="<?php echo dl_blog_e($recentTitleEn); ?>"><?php echo dl_blog_e($recentTitleAz ?: $recentTitleEn); ?></a></h6><ul class="rbt-meta"><li><i class="feather-clock"></i><?php echo dl_blog_e(dl_blog_date((string) ($recent['publishedDate'] ?? ''))); ?></li></ul></div></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
                    <div class="rbt-single-widget rbt-widget-tag"><div class="inner"><h4 class="rbt-widget-title" data-blog-i18n="blog_tags">Mövzular</h4><div class="rbt-sidebar-list-wrapper rbt-tag-list"><a href="#">Data Analitika</a><a href="#">SQL</a><a href="#">Excel</a><a href="#">AI</a><a href="#">Dashboard</a><a href="#">Karyera</a></div></div></div>
                </aside>
            </div></div></div>
        </div>
    </main>
